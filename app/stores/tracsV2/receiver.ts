...
import { useTransmitterApi, type Receiver, type TransmitterSavePayload } from '@/composables/tracsV2/useTransmitterApi';

export const useReceiverStore = defineStore('tracsV2/receiver', () => {
