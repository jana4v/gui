...
import { useTransmitterApi, type Transmitter, type TransmitterSavePayload } from '@/composables/tracsV2/useTransmitterApi';

export const useTransmitterStore = defineStore('tracsV2/transmitter', () => {
