  ...
  <div class="content">
    ...
    <div class="flex mt-10 gap-6">
      <div class="w-1/4">
        ...
        <Select
          v-model="selected_sg_name" class="w-full" :options="sg_options" option-label="v"
      ...
      <div class="w-1/4">
        ...
        <InputText v-model="sg_address" class="w-full" />
      </div>
      <div class="w-1/6">
        <label text-cyan-300>
          SG Model
        ...
        <Select
          v-model="selected_sg_model" class="mt-0 w-full" :options="sg_model_options" option-label="v"
      ...
      <div class="w-1/4">
        ...
        <InputText v-model="powermeter_address" class="w-full" />
      </div>
      <div class="w-1/6">
        <label text-cyan-300>
          PM Model
        ...
        <Select
          v-model="selected_powermeter_model" class="mt-0 w-full" :options="powermeter_options" option-label="v"
      ...
      <div class="w-1/4">
        ...
        <Select
          v-model="selected_sensor_channel" class="w-full" :options="sensor_options" option-label="v"
