...
const active = ref(0)
function tabChanged(val) { active.value = val; testProcedure.value = '' }
</script>

<template>
  <div class="content">
    <AppName appname="Manual TC Console" />
    <div class="">
      <Tabs>
        <TabList>
    ...
    <div v-if="active === 0">
      <h3>Def Limit</h3>
      <Textarea class="preserve-whitespace" spellcheck="false" :model-value="testProcedure" variant="filled" rows="15" cols="60" />
    </div>
