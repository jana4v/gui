...
<template>
  <div class="grid pt-4">
    ...
    <div class="pt-3">
      ...
      <Dropdown
        v-model="selectedTestPhase" :options="testPhaseNames" filter option-label="name"
    ...
    <div class="pt-3">
      ...
      <Dropdown
        v-model="selectedSubTestPhase" :options="subTestPhaseNames" filter option-label="name"
  ...
  <div class="grid mt-4">
    <Button
      class="p-button-lg mr-2" :disabled="disable_start_button" label="Start Phase Calibration Test"
      severity="success" @click="startPhaseCalTest"
    />
    <Button
      class="p-button-lg mr-2" :disabled="disable_pause_button" :label="pause_resume__button_label"
      severity="info" @click="pausePhaseCalTest"
    />
    <Button
      class="p-button-lg mr-2" :disabled="disable_stop_button" label="Abort" severity="warning"
      @click="abortPhaseCalTest"
    />
  </div>

  <div class="grid mt-1">
    <div class=""">
      <ExecutionStatus topic="com.gisat.phase.cal.status" />
    </div>
  </div>
</template>
