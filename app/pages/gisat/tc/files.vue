...
<template>
  <div class="grid pt-4">
    <div class="col-2">
      <h3>Select File</h3>
      <Dropdown
        v-model="selectedFileName" :options="fileNames" filter option-label="name" placeholder="Select File"
  ...
  <div v-if="selectedFileName" class="grid pt-4">
    <div class="col-6 gap-2">
      <Button label="Trigger Execution" severity="info" raised @click="executeTestProcedure" />
    </div>
  </div>
