...
const MANUAL_STORAGE_KEYS = {
  transmitter: 'tracsV2:measure:manual:transmitter',
  receiver: 'tracsV2:measure:manual:receiver',
  transponder: 'tracsV2:measure:manual:transponder',
} as const;
...
const ui = useUiStatePersistence('ui_state:tracsV2:index');
ui.bindRefs({
  selectedTestPhase,
