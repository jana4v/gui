    ...
    <div class="card flex flex-column mt-5 pt-5">
      ...
      <div class="col flex flex-wrap gap-2 pt-5">
        <div class="flex align-items-center">
          <RadioButton v-model="environment" input-id="NTP" name="NTP" value="ntp" @click="set_env('ntp')" />
          <label for="NTP" class="ml-2">NTP</label>
        </div>
        <div class="flex align-items-center">
          <RadioButton v-model="environment" input-id="TVAC" name="TVAC" value="tvac" @click="set_env('tvac')" />
