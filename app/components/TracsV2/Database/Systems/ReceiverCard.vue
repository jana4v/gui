<template>
  <div class="rx-card card">
    ...
    <div v-if="form.name.trim() && form.code.trim() && form.modulation_type === 'PSK_FM'" class="mt-2">
      <TracsV2ModulationFormsPskFmForm
...
import { useReceiverStore } from '@/stores/tracsV2/receiver';
import type { Receiver, PskPmDetails } from '@/composables/tracsV2/useTransmitterApi';
