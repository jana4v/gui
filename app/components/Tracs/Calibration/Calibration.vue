...
function tx_tbl_cell_value_changed() {
...
<template>
  <div class="card">
    <div class="grid">
      <div class="col-12">
        <h1 class="text-2xl text-primary-600 font-bold">
    ...
    <div class="grid pt-4">
      ...
      <div class="col-4">
        ...
        <Select
          v-model="selected_cal_type" :options="cal_types" filter option-label="value"
          option-value="value" input-id="Select_cal_type" placeholder="Select Cal Type" class="w-full"
        />
      </div>
      ...
      <div class="col-4">
        ...
        <Select
          v-model="selected_cal_type" :options="sub_test_phase_names" filter option-label="value"
          option-value="value" input-id="Select_sub_test_phase" placeholder="Enter DUT Label" class="w-full"
        />
      </div>
    </div>
    <div class="grid pt-4">
